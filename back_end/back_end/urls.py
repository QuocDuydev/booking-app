...
router.register(r'utilities', views.UtilitiesView, 'utilities')
...
urlpatterns = [
    ...
    path('api/utilities/<int:utilities_id>/', views.UtilitiesRetrieveUpdateDestroy.as_view(), name='utilities-details'),
