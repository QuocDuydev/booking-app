				...
				<div className="container mx-auto flex flex-wrap items-center justify-between text-gray-900">
					...
					<div className="hidden items-center gap-x-2 lg:flex">
						<div className="relative flex w-full gap-2 md:w-max">
							...
							/>
							<Button size="sm" color="red" className="ml-1 bg-black">
								Search
							</Button>
						</div>
						<Popover>
							<PopoverHandler>
								<div className="flex items-center">
									...
									/>
									<Typography variant="h6" className="ml-2 text-black">
										{username}
									</Typography>
								</div>
							</PopoverHandler>
				...
				<Collapse open={openNav}>
					<div className="container mx-auto justify-center">
						<div className="flex flex-col gap-x-2 sm:flex-row sm:items-center mb-auto">
							...
							<Button size="sm" className="mt-1 rounded-lg sm:mt-0 bg-black">
								Search
							</Button>
						</div>
