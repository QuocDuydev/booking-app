...
export default function ListCardHomeStay() {
	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				...
				const fillterHotels = hotelData.filter((hotel) => hotel.acctype === 2);
	...
	return (
		<>
			<div className=" container mt-6 flex">
				<BuildingLibraryIcon className="h-7 w-7 text-red-600 mr-3" />
				<Typography variant="h4">Danh sách HomeStay</Typography>
			</div>
