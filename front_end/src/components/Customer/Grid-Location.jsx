	...
	return (
		<>
			<div className="mt-[40px] mb-4">
				<Typography variant="h4">Explore Vietnam</Typography>
					...
					return (
						<div className="justify-center text-center" key={item.hotel_id}>
							<img
								...
								alt="gallery-photo"
							/>
							<div className="text-black font-bold mt-2">{item.location}</div>
							<div>{`${locationCounts[item.location] || 0} properties`}</div>
						</div>
					);
				})}
			</div>
