						...
						<CardBody className="flex">
							...
							<div className="m-3 flex flex-col justify-between w-2/3">
								...
								<div className="flex justify-between items-center mt-3 ">
									<Utilities />
									<span className=" hidden lg:block md:block mx-auto px-2 py-2 text-center text-lg leading-tight text-orange-700 bg-orange-100 rounded-full dark:text-white dark:bg-orange-600">
										{hotel.totalroom} - rooms
									</span>
								</div>
